...
```{r, echo=FALSE}
plot_table <- inner_join(q_means, snow_means, by='wtr_yr')

ggplot(data=plot_table, aes(x=mean_ndsi, y=median_q, color=wtr_yr)) +
       geom_point() +
...
```{r, echo=FALSE}
plot_table2 <- inner_join(q_means, snow_means, by='wtr_yr')

ggplot(data=plot_table2, aes(x=max_ndsi, y=median_q, color=wtr_yr)) +
       geom_point() +
